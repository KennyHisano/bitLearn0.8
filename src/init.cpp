...
bool AppInit(int argc, char* argv[])
{
    ...
    thread_group provides for a collection of threads
     that are related in some fashion. New threads can be added to 
     the group with add_thread and create_thread member functions.
    ...
    try
    {
        ...
        //through parsepatameters, mapArgs and mapMultiArgs are updated
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (mapArgs.count("-bind")) {
        ...
        //softsetboolarg in util.cpp 610. pass to sofsetarg,put value in mapArgs[](mapArgs is a map
    ...
    //hardware_concurrency to find running threads
    ...
    //getDataDir 1060~ in util. catch the path of firectory and lock
